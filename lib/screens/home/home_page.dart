  ...
  _buildQuizView() {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(10.0), // มุมขอบของกรอบ
        boxShadow: [
          BoxShadow(
      ...
      child: Column(
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              color: Colors.pink, // สีพื้นหลังของกล่องเพิ่มเติม
          ...
          Container(
            //padding: EdgeInsets.all(16.0), // ปรับขนาดขอบของกล่องเพิ่มเติม
            decoration: BoxDecoration(
              color: Colors.amberAccent, // สีพื้นหลังของกล่องเพิ่มเติม
          ...
          Container(
            //padding: EdgeInsets.all(16.0), // ปรับขนาดขอบของกล่องเพิ่มเติม
            decoration: BoxDecoration(
              color: Colors.yellow, // สีพื้นหลังของกล่องเพิ่มเติม
              borderRadius: BorderRadius.circular(10.0),
              border: Border.all(color: Colors.black),
          ...
          Container(
            //padding: EdgeInsets.all(16.0), // ปรับขนาดขอบของกล่องเพิ่มเติม
            decoration: BoxDecoration(
              color: Colors.lightGreenAccent, // สีพื้นหลังของกล่องเพิ่มเติม
              borderRadius: BorderRadius.circular(10.0),
              border: Border.all(color: Colors.black),
              // มุมขอบของกล่องเพิ่มเติม
            ),
